            ...
            <div>
              <div className="space-y-12">
                ...
                <div className="group">
                  ...
                  <a href="mailto:khalsaproperties1269@gmail.com" className="flex items-center gap-4 font-heading text-2xl md:text-4xl text-white group-hover:text-primary transition-colors break-all">
                    <Mail className="w-8 h-8 md:w-10 md:h-10 flex-shrink-0" />
                    khalsaproperties1269@gmail.com
                  </a>
                </div>
